...
public class FrmAdmin extends javax.swing.JFrame {
    ...
    private void mitDoceActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_mitDoceActionPerformed
        ...
        String x = FrmRegistrodocente.st;
        String y = FrmRegistroEstudiantes.b;
        if (x == null && y == null) {
            FrmRegistrodocente regi = new FrmRegistrodocente();
            dpregistro.add(regi);
            regi.show();
        } else {
    ...
    private void mitEstuActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_mitEstuActionPerformed
        ...
        String y = FrmRegistroEstudiantes.b;
        if (x == null && y == null) {
            FrmRegistroEstudiantes regi = new FrmRegistroEstudiantes();
            dpregistro.add(regi);
            regi.show();
        } else {
            JOptionPane.showMessageDialog(rootPane, "Por favor cierre la ventana para abrir una nueva");
